    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(blank=True, related_name='ideas', to='storage.category')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('idea', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='storage.idea')),
            ],
            options={
                'ordering': ['-created_at'],
            },
